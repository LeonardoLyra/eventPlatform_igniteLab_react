...
export function Lesson (props: LessonProps) {
    ...
    const availableAtDateFormated = format(props.availableAt, "EEEE ' • ' d 'de' MMMM ' • ' H'h'mm", {locale: ptBR,})
    ...
    return (
        <Link to={`/event/lesson/${props.slug}`} className='group'>
            ...
            <div className={classNames('border rounded-md border-gray-500 p-4 mt-2 group-hover:border-green-500', {
